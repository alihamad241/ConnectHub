...
public class test {
    public static void main(String[] args) {
        ...
        User user6 = manager.login("fahdbinhamad", "Ah20042411");
...
//
//        }
        System.out.println(user7.getFriendManagement().getFriends().size());
        System.out.println("User posts");
        ArrayList<Content> userPosts = ContentManager.UserContent(user6.getUserId());
